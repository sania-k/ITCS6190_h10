...
if not os.path.exists(MODEL_PATH):
    ...
    hist_windowed_df = hist_df_processed.groupBy(window(timeColumn=col("timestamp"),windowDuration="5 minutes")) \
...
# TCreate a VectorAssembler for the streaming features. It must match the one from training.
